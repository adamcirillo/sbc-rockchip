...
const (
	off int64 = 512 * 64
	dtb       = "rockchip/rk3588-rock-5b-plus.dtb"
)

func main() {
	adapter.Execute(&rock5b-plus{})
}

type rock5b-plus struct{}

type rock5b-plusExtraOptions struct {
	SPIBoot bool `yaml:"spi_boot,omitempty"`
}

func (i *rock5b-plus) GetOptions(extra rock5b-plusExtraOptions) (overlay.Options, error) {
	kernelArgs := []string{
		"cma=128MB",
		"console=tty0",
...
func (i *rock5b-plus) Install(options overlay.InstallOptions[rock5b-plusExtraOptions]) error {
